...
using Viamericas.Agencies.Business;
...
using Viamericas.Agencies.Data.Repositories;
using Viamericas.Agencies.Data.Repositories.Interfaces;

namespace Viamericas.Agencies.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IViamericasContext, ViamericasContext>();
            services.AddTransient<IUserRepository, UserRepository>();
            services.AddTransient<IUserBusiness, UserBusiness>();
            services.AddTransient<IAgencyRepository, AgencyRepository>();
            services.AddTransient<IAgencyBusiness, AgencyBusiness>();
            #endregion
        }
